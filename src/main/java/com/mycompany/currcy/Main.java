...
public class Main extends JFrame {
    ...
    private JLabel newValueLabel = new JLabel("Second value :");
    private JLabel valueLabel = new JLabel("First value :");
    ...
    private JButton convert = new JButton("Submit");
    ...
    Main() {
        ...
        frame.setTitle("soa_Currency Convertert");
